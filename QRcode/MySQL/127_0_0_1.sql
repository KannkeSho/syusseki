...
('root', '[{\"db\":\"sample\",\"table\":\"attendance\"},{\"db\":\"sample\",\"table\":\"student\"}]');
...
('root', '2024-12-12 02:08:40', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ja\",\"NavigationWidth\":683}');
...
INSERT INTO `attendance` (`studentId`, `subject`, `status`) VALUES
(11111111, '算数', 1),
(33333333, '算数', 1),
(44444444, '国語', 1);
...
INSERT INTO `student` (`studentId`, `studentNo`, `studentName`) VALUES
(11111111, 'IH1111', 'ドラえもん'),
(22222222, 'IH2222', '野比のび太'),
(33333333, 'IH3333', '源静香'),
(44444444, 'IH4444', '剛田武'),
(55555555, 'IH5555', '骨川スネ夫');
